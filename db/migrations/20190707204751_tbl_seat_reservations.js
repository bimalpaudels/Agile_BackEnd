...
exports.up =async function(knex, Promise) {
    await knex.schema.hasTable("tbl_seats_reservation");
  
    return await knex.schema.createTable("tbl_seats_reservation", table=>{
  ...
  exports.down = function(knex, Promise) {
    knex.schema.dropTable("tbl_seats_reservation");  
  };
